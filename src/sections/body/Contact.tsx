  ...
  return (
    ...
    >
      <div className="flex flex-col gap-12 min-h-screen text-center  pt-40 sm:pt-36 lg:px-20 w-[calc(100vw-1rem)] xs:w-body-sm min-w-body max-w-body sm:w-body mx-auto">
        ...
        To get involved with London Data Week 2024, fill out our
        <a href="https://airtable.com/appzyMC4CJl7GwcK5/shrRXtM6RidqKM6qu"> <u>call for participation form</u> </a>
         to apply to host an event or volunteer!
        </p>
